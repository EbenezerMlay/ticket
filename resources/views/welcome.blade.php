    ...
    <div id="container-fluid">
     <div id="navbar">
                  ...
                  <p class="search-title"> Search for trip </p>
                            <form action="/search" method="" role="search" class="trip-form">
                             {{ csrf_field() }}
                                    <div class="row" class="trip-info">
                                      <div class="col">
                                      		
		
                                        <input type="text" name="q" required class="form-control" placeholder="leaving from">
                                      </div>
                                      <div class="col">
                                        <input type="text" name="d" required class="form-control" placeholder="Destination">
                                      </div>
                                    </div>
                                    <br>
                                    <div class="row" class="trip-date">
                                      <div class="col">
                                            <input type="date" class="form-control calender" >
